/*
Copyright (C): 2019, Zhuhai Chaos Tech
...
namespace Gaia {
     ...
     * @param index
     */   
    //% blockId=Gaia_RGB_Program block="RGB_Program"
    //% weight=99
    //% blockGap=10
    ...
    //% blockId=Gaia_Music block="Music|%index"
    //% weight=98
    //% blockGap=10
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=4
    ...
    //% blockId=Gaia_Servo block="Servo(180°)|num %num|value %value"
    //% weight=97
    //% blockGap=10
    ...
    //% blockId=Gaia_Servo2 block="Servo(270°)|num %num|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=Gaia_Servo3 block="Servo(360°)|num %num|pos %pos|value %value"
    //% weight=96
    //% blockGap=10
    ...
    //% blockId=Gaia_MotorRun block="Motor|%index|speed(-255~255) %speed"
    //% weight=93
    ...
    //% blockId=Gaia_MotorRunDual block="Motor|%motor1|speed %speed1|%motor2|speed %speed2"
    //% weight=92
    //% blockGap=50
    ...
    //% blockId=Gaia_StepperDegree block="Stepper Motor(28BYJ-48) |%index|degree %degree"
    //% weight=90
    ...
    //% blockId=Gaia_MotorStopAll block="Motor Stop All"
    //% weight=91
    //% blockGap=50
    ...
    //% blockId=Gaia_StepperTurn block="Stepper Motor(28BYJ-48) |%index|turn %turn|circle"
    //% weight=89
    ...
    //% blockId=Gaia_StepperDual block="Dual Stepper Motor(Degree) |M1 %degree1| M2 %degree2"
    //% weight=88
    ...
    //% blockId=Gaia_PWMOFF block="PWM OFF|%index"
    //% weight=87
